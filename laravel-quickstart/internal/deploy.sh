...
#ben SRC_MASTER_URL="http://<your-jenkins-server-ip>:8080"
SRC_MASTER_URL="http://192.168.56.154:8080"

#SERVER
#ben SERVERS="ubuntu@<your-app-server-ip>"
#ben SERVERS="ubuntu@192.168.56.154"
SERVERS="ubuntu@192.168.56.155"
SERVER_DOCKER_PATH="/var/dockers/$SITE_NAME"
SERVER_SOURCE_PATH="/var/www/$SITE_NAME"

#GITS
#ben GITREPO_URL="https://$GIT_USER:$GIT_PASS@github.com/<your-github-username>"
GITREPO_URL="https://$GIT_USER:$GIT_PASS@github.com/benopenair"
